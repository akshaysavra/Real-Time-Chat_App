...
const Navbar = () => {
  ...
  return <>
    <header className="fixed top-0 w-full z-40bg-white/80 backdrop-blur-1g border border-gray-200
shadow-sm">
        ...
        <div className="flex items-center justify-between h-full">
          ...
          <div className="flex items-center gap-8">
            <Link to={"/"}
              ...
              <div className="w-9 h-9 rounded-1gbg-blue-100 flex items-center justify-center">
